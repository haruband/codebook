...
- K8S.Node0 : 192.168.200.200 (f4:6b:8c:82:42:33)
- K8S.Node1 : 192.168.200.201 (f4:6b:8c:82:42:2b)
- K8S.Node2 : 192.168.200.202 (f4:6b:8c:82:41:f8)
...
참고로 Node0 의 Cilium 서비스 목록을 살펴보면, 0번 브로커의 로드밸런서 주소에 대한 백엔드가 비어있는 것을 볼 수 있다. 이는 앞에서 외부 트래픽 정책을 로컬로 설정했기 때문에 다른 노드에 있는 파드는 백엔드 목록에서 제거하기 때문이다.
